...
(function() {
  ...
  exports.Block = Block = (function(_super) {
    ...
    Block.prototype.compileRoot = function(o) {
      var aliases, code, comparator, exp, i, idt, inc, includes, includesJs, name, prelude, preludeExps, provides, providesJs, rest;
      o.indent = o.bare ? '' : TAB;
      ...
      if (o.google) {
        ...
        aliases = (function() {
          ...
          for (_i = 0, _len = includes.length; _i < _len; _i++) {
            inc = includes[_i];
            if (inc.alias) _results.push(inc);
          }
          return _results;
        })();
  ...
  exports.Call = Call = (function(_super) {
    ...
    Call.prototype.isGoogRequire = function() {
      return this.variable instanceof Value && this.variable.base.value === 'goog' && this.variable.properties.length === 1 && this.variable.properties[0] instanceof Access && this.variable.properties[0].name.value === 'require' && this.args.length === 1 && this.args[0].isString();
    };

    Call.prototype.compileNode = function(o) {
      var arg, arg_value, args, code, pkg_name, _ref3;
      ...
      } else if (o.google && this.isGoogRequire()) {
        arg_value = this.args[0].base.value;
  ...
  exports.Class = Class = (function(_super) {
    ...
    Class.prototype.determineName = function(o) {
      ...
      if (o.google) return this.variable.compile(o);
    ...
    Class.prototype.compileNode = function(o) {
      ...
      if (!o.google) this.body.expressions.push(lname);
  ...
  exports.Code = Code = (function(_super) {
    ...
    Code.prototype.compileNode = function(o) {
      var code, exprs, extendsNode, i, idt, isGoogleConstructor, jsDoc, jsDocLines, line, lit, name, p, param, params, parentClassName, ref, splats, uniqs, val, wasEmpty, _i, _j, _k, _l, _len, _len2, _len3, _len4, _len5, _len6, _m, _n, _ref3, _ref4, _ref5, _ref6, _ref7, _ref8, _ref9;
      ...
      if (jsDoc.length) {
        jsDocLines = (function() {
          ...
          _results = [];
          for (_o = 0, _len7 = jsDoc.length; _o < _len7; _o++) {
            line = jsDoc[_o];
            _results.push("" + this.tab + " * " + line);
          }
          return _results;
        }).call(this);
        code = '/**\n' + jsDocLines.join('\n') + '\n */\n' + code;
